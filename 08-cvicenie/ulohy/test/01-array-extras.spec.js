...
describe("FP - array functions", function() {
  ...
  function totalPoints(student) {
    return student.points === undefined ? undefined : student.points.reduce((x,y)=>x+y,0)
  }
    ...
    let groupedByProject = students
      ...
      .reduce((uniqueProjects, student) => {
        student.projects.forEach((project)=>{
          let group = uniqueProjects.get(project);
          !group ? group = [student] : group.push(student);
          uniqueProjects.set(project, group);
        })
